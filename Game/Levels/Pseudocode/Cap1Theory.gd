...
func _ready():
	...
	rpg_dialog.add_section(pet_name, "Normalmente usted verá una parte teórica y otra parte práctica, en la parte teórica me verá a mi hablando cosas y en la parte práctica, podremos a prueba lo estudiado.")
